...
if st.button("🔢 توليد الأكواد"):
    ...
    for committee in committees:
        ...
        for i in range(1, num_students + 1):
            ...
            current_letter = chr(code_letter_start + letter_index)
...
st.markdown(
    "<p style='text-align:center; color:gray;'>إعداد: يوسف باهي – المعيد بقسم إدارة الأعمال، كلية الأعمال، جامعة الإسكندرية</p>",
    unsafe_allow_html=True
)